...
Text {
    ...
    FontLoader { id: notoTC; source: "file:///" + appDirPath + "/resources/fonts/NotoSerifCJKtc-Regular.otf" }
    FontLoader { id: notoHK; source: "file:///" + appDirPath + "/resources/fonts/NotoSerifCJKhk-Regular.otf" }
