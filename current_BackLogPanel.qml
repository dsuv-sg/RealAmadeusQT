...
Item {
    ...
    Item {
        ...
        Text {
            ...
            text: "BACKLOG"
            color: "#FF9900"
            font { family: (typeof NotoKRFamily !== 'undefined' && NotoKRFamily ? NotoKRFamily : "MS Mincho"); pixelSize: 64 }
            ...
            Repeater {
                ...
                delegate: Item {
                    ...
                    Row {
                        ...
                        ScriptedText {
                            rawText: (function(){
                                var langIdx = root.configLanguage;
                                switch (model.role) {
                                    case "user": case "me":
                                        if (langIdx === 0) return "あなた";
                                        if (langIdx === 1) return "You";
                                        if (langIdx === 2) return "你";
                                        if (langIdx === 3) return "당신";
                                        if (langIdx === 4) return "Tú";
                                        if (langIdx === 5) return "Vous";
                                        if (langIdx === 6) return "Du";
                                        if (langIdx === 7) return "Вы";
                                        return "You";
                                    case "assistant": case "kurisu": case "amadeus":
                                        if (langIdx === 0) return "アマデウス紅莉栖";
                                        if (langIdx === 1) return "Amadeus Kurisu";
                                        if (langIdx === 2) return "阿玛迪斯·红莉栖";
                                        if (langIdx === 3) return "아마데우스 쿠리스";
                                        if (langIdx === 4) return "Amadeus Kurisu";
                                        if (langIdx === 5) return "Amadeus Kurisu";
                                        if (langIdx === 6) return "Amadeus Kurisu";
                                        if (langIdx === 7) return "Амадеус Курису";
                            ...
                            font.pixelSize: root.backlogFontSize
                            font.bold: true
    ...
    Rectangle {
        ...
        Text {
            ...
            color: "#FFFFFF"
            font { family: (typeof NotoKRFamily !== 'undefined' && NotoKRFamily ? NotoKRFamily : "MS Mincho"); pixelSize: 32 }
        }
        MouseArea {
            anchors.fill: parent
